...
public class MadlibsOfTheAmazon {
	public static void main(String[] args) {
		...
		String answer = JOptionPane.showInputDialog("Enter an adjective");
		...
		JOptionPane.showMessageDialog(null,
				"Piranhas are more " + answer
						+ " during the day, so cross the river at night. Piranhas are attracted to fresh " + answer2
						+ " and will most likely take a bite out of your " + answer3 + " if you " + answer4
